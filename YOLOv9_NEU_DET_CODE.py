# YOLOv9_NEU_DET -- Code extracted from notebook
...
# ======================================================================
from ultralytics import YOLO
project_dir_YOLOv9 = os.path.join(MODEL_DIR["YOLOv9"]["weights"])
print("YOLOv9 ready. Pretrained weights: yolov9c.pt")
print("Output directory:", project_dir_YOLOv9)


# ======================================================================
# CODE CELL 14
# ======================================================================
model_YOLOv9, YOLOv9_training_time_s = ultralytics_train("YOLOv9", "yolov9c.pt", project_dir_YOLOv9)
YOLOv9_ready = True
try:
    _args = model_YOLOv9.trainer.args
...
print(f"\nTraining time: {YOLOv9_training_time_s:.1f} s")


# ======================================================================
# CODE CELL 15
# ======================================================================
YOLOv9_overall, YOLOv9_per_class, YOLOv9_metrics = ultralytics_evaluate(
    "YOLOv9", model_YOLOv9, "yolov9c.pt", YOLOv9_training_time_s)
YOLOv9_overall.update({"Architecture": "PGI (Programmable Gradient Information) for deep-network gradient preservation", "Backbone": "GELAN (generalized ELAN aggregation)"})
for row in YOLOv9_per_class: row["Model"] = "YOLOv9"
save_overall_result("YOLOv9", YOLOv9_overall)
save_per_class_result("YOLOv9", YOLOv9_per_class)
print(YOLOv9_overall)


# ======================================================================
# CODE CELL 16
# ======================================================================
ultralytics_curves("YOLOv9", project_dir_YOLOv9)
ultralytics_confusion_pr("YOLOv9", YOLOv9_metrics)
...
print("Upload an image to test with YOLOv9:")
uploaded = files.upload()
for fname in uploaded.keys():
    img_path = os.path.join("/content", fname)
    ultralytics_inference(model_YOLOv9, img_path, MODEL_DIR["YOLOv9"]["inference_results"], "YOLOv9")
