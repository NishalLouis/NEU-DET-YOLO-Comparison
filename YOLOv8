# YOLOv8_NEU_DET -- Code extracted from notebook
...
# ======================================================================
from ultralytics import YOLO
project_dir_YOLOv8 = os.path.join(MODEL_DIR["YOLOv8"]["weights"])
print("YOLOv8 ready. Pretrained weights: yolov8n.pt")
print("Output directory:", project_dir_YOLOv8)


# ======================================================================
# CODE CELL 14
# ======================================================================
model_YOLOv8, YOLOv8_training_time_s = ultralytics_train("YOLOv8", "yolov8n.pt", project_dir_YOLOv8)
YOLOv8_ready = True
try:
    _args = model_YOLOv8.trainer.args
...
print(f"\nTraining time: {YOLOv8_training_time_s:.1f} s")


# ======================================================================
# CODE CELL 15
# ======================================================================
YOLOv8_overall, YOLOv8_per_class, YOLOv8_metrics = ultralytics_evaluate(
    "YOLOv8", model_YOLOv8, "yolov8n.pt", YOLOv8_training_time_s)
YOLOv8_overall.update({"Architecture": "Anchor-free, decoupled head; C2f backbone module", "Backbone": "C2f (richer gradient flow than v5's C3)"})
for row in YOLOv8_per_class: row["Model"] = "YOLOv8"
save_overall_result("YOLOv8", YOLOv8_overall)
save_per_class_result("YOLOv8", YOLOv8_per_class)
print(YOLOv8_overall)


# ======================================================================
# CODE CELL 16
# ======================================================================
ultralytics_curves("YOLOv8", project_dir_YOLOv8)
ultralytics_confusion_pr("YOLOv8", YOLOv8_metrics)
...
print("Upload an image to test with YOLOv8:")
uploaded = files.upload()
for fname in uploaded.keys():
    img_path = os.path.join("/content", fname)
    ultralytics_inference(model_YOLOv8, img_path, MODEL_DIR["YOLOv8"]["inference_results"], "YOLOv8")
