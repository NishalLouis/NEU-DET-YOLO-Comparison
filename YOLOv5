# YOLOv5_NEU_DET -- Code extracted from notebook
...
# ======================================================================
from ultralytics import YOLO
project_dir_YOLOv5 = os.path.join(MODEL_DIR["YOLOv5"]["weights"])
print("YOLOv5 ready. Pretrained weights: yolov5su.pt")
print("Output directory:", project_dir_YOLOv5)


# ======================================================================
# CODE CELL 14
# ======================================================================
model_YOLOv5, YOLOv5_training_time_s = ultralytics_train("YOLOv5", "yolov5su.pt", project_dir_YOLOv5)
YOLOv5_ready = True
try:
    _args = model_YOLOv5.trainer.args
...
print(f"\nTraining time: {YOLOv5_training_time_s:.1f} s")


# ======================================================================
# CODE CELL 15
# ======================================================================
YOLOv5_overall, YOLOv5_per_class, YOLOv5_metrics = ultralytics_evaluate(
    "YOLOv5", model_YOLOv5, "yolov5su.pt", YOLOv5_training_time_s)
YOLOv5_overall.update({"Architecture": "CSPDarknet backbone, PANet neck, anchor-based 3-scale detection (Ultralytics' 'u' update)", "Backbone": "CSPDarknet (close to v4's, PyTorch reimplementation)"})
for row in YOLOv5_per_class: row["Model"] = "YOLOv5"
save_overall_result("YOLOv5", YOLOv5_overall)
save_per_class_result("YOLOv5", YOLOv5_per_class)
print(YOLOv5_overall)


# ======================================================================
# CODE CELL 16
# ======================================================================
ultralytics_curves("YOLOv5", project_dir_YOLOv5)
ultralytics_confusion_pr("YOLOv5", YOLOv5_metrics)
...
print("Upload an image to test with YOLOv5:")
uploaded = files.upload()
for fname in uploaded.keys():
    img_path = os.path.join("/content", fname)
    ultralytics_inference(model_YOLOv5, img_path, MODEL_DIR["YOLOv5"]["inference_results"], "YOLOv5")
