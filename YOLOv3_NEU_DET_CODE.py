# YOLOv3_NEU_DET -- Code extracted from notebook
...
# ======================================================================
from ultralytics import YOLO
project_dir_YOLOv3 = os.path.join(MODEL_DIR["YOLOv3"]["weights"])
print("YOLOv3 ready. Pretrained weights: yolov3u.pt")
print("Output directory:", project_dir_YOLOv3)


# ======================================================================
# CODE CELL 14
# ======================================================================
model_YOLOv3, YOLOv3_training_time_s = ultralytics_train("YOLOv3", "yolov3u.pt", project_dir_YOLOv3)
YOLOv3_ready = True
try:
    _args = model_YOLOv3.trainer.args
...
print(f"\nTraining time: {YOLOv3_training_time_s:.1f} s")


# ======================================================================
# CODE CELL 15
# ======================================================================
YOLOv3_overall, YOLOv3_per_class, YOLOv3_metrics = ultralytics_evaluate(
    "YOLOv3", model_YOLOv3, "yolov3u.pt", YOLOv3_training_time_s)
YOLOv3_overall.update({"Architecture": "Darknet-53 backbone, 3-scale detection heads (FPN-style), Ultralytics' anchor-free-head update", "Backbone": "Darknet-53 (53 conv layers, residual connections)"})
for row in YOLOv3_per_class: row["Model"] = "YOLOv3"
save_overall_result("YOLOv3", YOLOv3_overall)
save_per_class_result("YOLOv3", YOLOv3_per_class)
print(YOLOv3_overall)


# ======================================================================
# CODE CELL 16
# ======================================================================
ultralytics_curves("YOLOv3", project_dir_YOLOv3)
ultralytics_confusion_pr("YOLOv3", YOLOv3_metrics)
...
print("Upload an image to test with YOLOv3:")
uploaded = files.upload()
for fname in uploaded.keys():
    img_path = os.path.join("/content", fname)
    ultralytics_inference(model_YOLOv3, img_path, MODEL_DIR["YOLOv3"]["inference_results"], "YOLOv3")
