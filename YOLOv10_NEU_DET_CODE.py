# YOLOv10_NEU_DET -- Code extracted from notebook
...
# ======================================================================
from ultralytics import YOLO
project_dir_YOLOv10 = os.path.join(MODEL_DIR["YOLOv10"]["weights"])
print("YOLOv10 ready. Pretrained weights: yolov10n.pt")
print("Output directory:", project_dir_YOLOv10)


# ======================================================================
# CODE CELL 14
# ======================================================================
model_YOLOv10, YOLOv10_training_time_s = ultralytics_train("YOLOv10", "yolov10n.pt", project_dir_YOLOv10)
YOLOv10_ready = True
try:
    _args = model_YOLOv10.trainer.args
...
print(f"\nTraining time: {YOLOv10_training_time_s:.1f} s")


# ======================================================================
# CODE CELL 15
# ======================================================================
YOLOv10_overall, YOLOv10_per_class, YOLOv10_metrics = ultralytics_evaluate(
    "YOLOv10", model_YOLOv10, "yolov10n.pt", YOLOv10_training_time_s)
YOLOv10_overall.update({"Architecture": "NMS-free end-to-end detection via dual label assignment", "Backbone": "CSPNet-derived, similar lineage to v8's C2f"})
for row in YOLOv10_per_class: row["Model"] = "YOLOv10"
save_overall_result("YOLOv10", YOLOv10_overall)
save_per_class_result("YOLOv10", YOLOv10_per_class)
print(YOLOv10_overall)


# ======================================================================
# CODE CELL 16
# ======================================================================
ultralytics_curves("YOLOv10", project_dir_YOLOv10)
ultralytics_confusion_pr("YOLOv10", YOLOv10_metrics)
...
print("Upload an image to test with YOLOv10:")
uploaded = files.upload()
for fname in uploaded.keys():
    img_path = os.path.join("/content", fname)
    ultralytics_inference(model_YOLOv10, img_path, MODEL_DIR["YOLOv10"]["inference_results"], "YOLOv10")
